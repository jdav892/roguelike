...
item_chances: Dict[int, List[Tuple[Entity, int]]] = {
    ...
    2: [(entity_factories.confusion_scroll, 25), (entity_factories.lightning_scroll, 20), (entity_factories.sword, 5)],
    3: [(entity_factories.greater_health_potion, 35)],
    4: [(entity_factories.lightning_scroll, 25), (entity_factories.blizzard_scroll, 20), (entity_factories.chain_mail, 15)],
    6: [(entity_factories.greater_health_potion, 50), (entity_factories.pyroclasm_scroll, 25), (entity_factories.battle_axe, 15), (entity_factories.plate_mail, 15)],
}
...
class RectangularRoom:
    ...
    def inner(self) -> Tuple[slice, slice]:
        """Return the inner are of this room as a 2D array index."""
...
def generate_dungeon(
    ...
    for r in range(max_rooms):
        ...
        if any(new_room.intersects(other_room) for other_room in rooms):
            continue # This room intersects so go to next 
        #if there are no intersections then this is valid
